...
namespace Hobgoblin.InventoryMvc
{
    public class InventoryView : MonoBehaviour, IObserver<InventoryData>
    {
        ...
        public InventoryView(InventoryController pController)
        {
            ...
            _keyCommands = new List<KeyCommand>()
            {
                new KeyCommand(KeyCode.LeftArrow, moveSelectionLeft),
                new KeyCommand(KeyCode.RightArrow, moveSelectionRight),
                new KeyCommand(KeyCode.UpArrow, moveSelectionUp),
                new KeyCommand(KeyCode.DownArrow, moveSelectionDown),
                new KeyCommand(KeyCode.E,null)
        };
